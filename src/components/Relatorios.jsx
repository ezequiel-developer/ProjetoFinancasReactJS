...
const Relatorios = () => {
    return (
        <div className='flex flex-col justify-center h-screen p-4'>
            ...
            <div className='flex flex-col  md:flex-row gap-2 mt-20 pt-4 pb-4'>

                <div className='bg-white border-4 shadow-black shadow-xl border-green-500 flex-1 p-4 rounded-xl'>
                    <h2 className='text-center text-black uppercase text-2xl font-bold mb-4'>Receitas</h2>
                    <GraficoReceitas className='text-white' />
                </div>

                <div className='bg-white  border-4 shadow-black shadow-xl border-red-500 p-4 flex-1 rounded-xl'>
                    <h2 className='text-center text-black uppercase text-2xl font-bold mb-4'>Despesas</h2>
                    <GraficoDespesas className='text-white' />
                </div>

                <div className='bg-white shadow-black shadow-xl  border-4 border-blue-500 p-4 flex-1 rounded-xl'>
