...
const Dashboard = () => {
    ...
    return (
        <div>
            ...
            <div className='bg-[#343434] w-full p-2 text-center text-xl rounded-xl'>
                <h2 className='font-semibold'>Saldo Atual</h2>
                <p className={`${saldoAtual > 0 ? 'text-green-500 text-2xl font-bold' : saldoAtual < 0 ? 'text-red-500 text-2xl font-bold' : 'text-white text-2xl font-bold'}`}>{formatCurrency(saldoAtual)}</p>
            </div>

            <div className='flex mt-4 justify-between gap-4 text-center'>
                <div className='bg-[#343434] flex-1 p-2 rounded-xl'>
